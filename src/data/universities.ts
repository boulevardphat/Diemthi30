...
export const UNIVERSITIES_DB: University[] = [
  ...
  },
  {
    ...
    logo: "https://upload.wikimedia.org/wikipedia/commons/e/e5/VNU_Logo.png",
    majors: [
      { code: "7320101", name: "Báo chí", blocks: ["C00", "D01", "D14"] },
      { code: "7320101_CLC", name: "Báo chí (Chương trình Chuẩn Quốc tế)", blocks: ["C00", "D01", "D14"] },
      { code: "7320104", name: "Truyền thông đa phương tiện", blocks: ["D01", "D14", "D15"] },
      { code: "7320108", name: "Quan hệ công chúng", blocks: ["D01", "D14", "D15"] },
      { code: "7310401", name: "Tâm lý học", blocks: ["B00", "C00", "D01", "D14"] },
      { code: "7310403", name: "Tâm lý học giáo dục", blocks: ["B00", "B08", "D01", "D14"] },
      { code: "7310206", name: "Quan hệ quốc tế", blocks: ["D01", "D14"] },
      { code: "7310206_CLC", name: "Quan hệ quốc tế (Chương trình Chuẩn Quốc tế)", blocks: ["D01", "D14"] },
      { code: "7220201", name: "Ngôn ngữ Anh", blocks: ["D01"] },
      { code: "7220201_CLC", name: "Ngôn ngữ Anh (Chương trình Chuẩn Quốc tế)", blocks: ["D01"] },
      { code: "7220204", name: "Ngôn ngữ Trung Quốc", blocks: ["D01", "D04", "D14"] },
      { code: "7220204_CLC", name: "Ngôn ngữ Trung Quốc (Chương trình Chuẩn Quốc tế)", blocks: ["D01", "D04", "D14"] },
      { code: "7310608", name: "Đông phương học", blocks: ["D01", "D04", "D14", "D15"] },
      { code: "7310614", name: "Hàn quốc học", blocks: ["D01", "D14"] },
      { code: "7310613", name: "Nhật Bản học", blocks: ["D01", "D06", "D14"] },
      { code: "7310613_CLC", name: "Nhật Bản học (Chương trình Chuẩn Quốc tế)", blocks: ["D01", "D06", "D14"] },
      { code: "7220202", name: "Ngôn ngữ Nga", blocks: ["D01", "D02", "D14"] },
      { code: "7220203", name: "Ngôn ngữ Pháp", blocks: ["D01", "D03", "D14"] },
      { code: "7220205", name: "Ngôn ngữ Đức", blocks: ["D01", "D05", "D14"] },
      { code: "7220205_CLC", name: "Ngôn ngữ Đức (Chương trình Chuẩn Quốc tế)", blocks: ["D01", "D05", "D14"] },
      { code: "7220206", name: "Ngôn ngữ Tây Ban Nha", blocks: ["D01", "D03", "D05", "D14"] },
      { code: "7220208", name: "Ngôn ngữ Italia", blocks: ["D01", "D03", "D05", "D14"] },
      { code: "7229001", name: "Triết học", blocks: ["A01", "C00", "D01", "D14"] },
      { code: "7229009", name: "Tôn giáo học", blocks: ["C00", "D01", "D14"] },
      { code: "7229010", name: "Lịch sử", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7229020", name: "Ngôn ngữ học", blocks: ["C00", "D01", "D14"] },
      { code: "7229030", name: "Văn học", blocks: ["C00", "D01", "D14"] },
      { code: "7229040", name: "Văn hoá học", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7140101", name: "Giáo dục học", blocks: ["B00", "C00", "C01", "D01"] },
      { code: "7140114", name: "Quản lý giáo dục", blocks: ["A01", "C00", "D01", "D14"] },
      { code: "7210213", name: "Nghệ thuật học", blocks: ["C00", "D01", "D14"] },
      { code: "7320201", name: "Thông tin - thư viện", blocks: ["A01", "C00", "D01", "D14"] },
      { code: "7320205", name: "Quản lý thông tin", blocks: ["A01", "C00", "D01", "D14"] },
      { code: "7320303", name: "Lưu trữ học", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7580112", name: "Đô thị học", blocks: ["A01", "C00", "D01", "D14"] },
      { code: "7310301", name: "Xã hội học", blocks: ["A00", "C00", "D01", "D14"] },
      { code: "7310302", name: "Nhân học", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7310501", name: "Địa lý học", blocks: ["A01", "C00", "D01", "D15"] },
      { code: "7310601", name: "Quốc tế học", blocks: ["D01", "D09", "D14", "D15"] },
      { code: "7310630", name: "Việt Nam học", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "73106a1", name: "Kinh doanh thương mại Hàn Quốc", blocks: ["D01", "D14"] },
      { code: "7340406", name: "Quản trị văn phòng", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7810103", name: "Quản trị dịch vụ du lịch và lữ hành", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7810103_CLC", name: "Quản trị dịch vụ du lịch và lữ hành (Chương trình Chuẩn Quốc tế)", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7760101", name: "Công tác xã hội", blocks: ["C00", "D01", "D14", "D15"] },
      { code: "7140107", name: "Quản trị chất lượng giáo dục", blocks: ["C03", "D01", "D14", "D15"] },
      { code: "7220104", name: "Hán Nôm", blocks: ["D01", "D14"] }
    ]
  },
  {
    id: "hcmiu",
    ...
    majors: [
      ...
      { code: "7480109", name: "Khoa học Dữ liệu", blocks: ["A00", "A01", "D01", "D07"] },
      { code: "7480120", name: "Trí tuệ Nhân tạo", blocks: ["A00", "A01", "D01", "D07"] },
      { code: "7520216", name: "Kỹ thuật Điều khiển và Tự động hóa", blocks: ["A00", "A01", "D01", "D07"] },
      { code: "7520207", name: "Kỹ thuật Điện tử - Viễn thông", blocks: ["A00", "A01", "D01", "D07"] },
      { code: "7420201", name: "Công nghệ Sinh học", blocks: ["A00", "B00", "D07", "D08"] },
      { code: "7540101", name: "Công nghệ Thực phẩm", blocks: ["A00", "B00", "D07", "D08"] },
      { code: "7220201", name: "Ngôn ngữ Anh", blocks: ["D01", "D14", "D15", "A01"] },
      { code: "7520212", name: "Kỹ thuật Y sinh", blocks: ["A00", "A01", "B00", "D07"] },
      { code: "7580201", name: "Kỹ thuật Xây dựng", blocks: ["A00", "A01", "D01", "D07"] }
    ]
  },
  {
    id: "agu",
  ...
  },
  {
    ...
    majors: [
      { code: "7140114", name: "Quản lý giáo dục", blocks: ["D01"] },
      { code: "7140201", name: "Giáo dục Mầm non", blocks: ["M01"] },
      { code: "7140202", name: "Giáo dục Tiểu học", blocks: ["C01", "D01", "A00"] },
      { code: "7140205", name: "Giáo dục chính trị", blocks: ["C01", "C00"] },
      { code: "7140209", name: "Sư phạm Toán học", blocks: ["A00", "A01"] },
      { code: "7140211", name: "Sư phạm Vật lý", blocks: ["A00", "A01"] },
      { code: "7140212", name: "Sư phạm Hóa học", blocks: ["A00", "B00"] },
      { code: "7140213", name: "Sư phạm Sinh học", blocks: ["B00"] },
      { code: "7140217", name: "Sư phạm Ngữ văn", blocks: ["C01", "C00", "D01"] },
      { code: "7140218", name: "Sư phạm Lịch sử", blocks: ["C00"] },
      { code: "7140219", name: "Sư phạm Địa lý", blocks: ["C00", "D01"] },
      { code: "7140221", name: "Sư phạm Âm nhạc", blocks: ["N01"] },
      { code: "7140222", name: "Sư phạm Mỹ thuật", blocks: ["H00"] },
      { code: "7140231", name: "Sư phạm Tiếng Anh", blocks: ["D01"] },
      { code: "7140247", name: "Sư phạm Khoa học tự nhiên", blocks: ["A00", "B00"] },
      { code: "7140249", name: "Sư phạm Lịch sử - Địa lý", blocks: ["C00"] },
      { code: "7220201", name: "Ngôn ngữ Anh", blocks: ["D01"] },
      { code: "7220201C", name: "Ngôn ngữ Anh (Chương trình đào tạo chất lượng cao)", blocks: ["D01"] },
      { code: "7229010", name: "Lịch sử", blocks: ["C00"] },
      { code: "7310401", name: "Tâm lý học", blocks: ["D01", "C00", "B00"] },
      { code: "7310501", name: "Địa lý học", blocks: ["C00", "D01"] },
      { code: "7310601", name: "Quốc tế học", blocks: ["D01", "D78"] },
      { code: "7310630", name: "Việt Nam học", blocks: ["C00", "D01"] },
      { code: "7320201", name: "Thông tin - Thư viện", blocks: ["C00", "D01"] },
      { code: "7340101", name: "Quản trị kinh doanh", blocks: ["D01", "A00", "A01"] },
      { code: "7340101C", name: "Quản trị kinh doanh (Chương trình đào tạo chất lượng cao)", blocks: ["D01", "A00", "A01"] },
      { code: "7340120", name: "Kinh doanh quốc tế", blocks: ["D01", "A00", "A01"] },
      { code: "7340201", name: "Tài chính - Ngân hàng", blocks: ["D01", "A00", "A01"] },
      { code: "7340301", name: "Kế toán", blocks: ["D01", "A00", "A01"] },
      { code: "7340301C", name: "Kế toán (Chương trình đào tạo chất lượng cao)", blocks: ["D01", "A00", "A01"] },
      { code: "7340302", name: "Kiểm toán", blocks: ["D01", "A00", "A01"] },
      { code: "7340406", name: "Quản trị văn phòng", blocks: ["D01", "C00"] },
      { code: "7380101", name: "Luật", blocks: ["D01", "C00", "A01"] },
      { code: "7440301", name: "Khoa học môi trường", blocks: ["B00", "A00"] },
      { code: "7460108", name: "Khoa học dữ liệu", blocks: ["A00", "A01"] },
      { code: "7460112", name: "Toán ứng dụng", blocks: ["A00", "A01"] },
      { code: "7480103", name: "Kỹ thuật phần mềm", blocks: ["D01", "A00", "A01"] },
      { code: "7480107", name: "Trí tuệ nhân tạo", blocks: ["D01", "A00", "A01"] },
      { code: "7480201", name: "Công nghệ thông tin", blocks: ["D01", "A00", "A01"] },
      { code: "7480201C", name: "Công nghệ thông tin (Chương trình đào tạo chất lượng cao)", blocks: ["D01", "A00", "A01"] },
      { code: "7510301", name: "Công nghệ kỹ thuật điện, điện tử", blocks: ["A01", "A00"] },
      { code: "7510302", name: "Công nghệ kỹ thuật điện tử - viễn thông", blocks: ["A01", "A00"] },
      { code: "7510406", name: "Công nghệ kỹ thuật môi trường", blocks: ["B00", "A00"] },
      { code: "7520201", name: "Kỹ thuật điện", blocks: ["A01", "A00"] },
      { code: "7520207", name: "Kỹ thuật điện tử - viễn thông (Thiết kế vi mạch)", blocks: ["A01", "A00"] },
      { code: "7810101", name: "Du lịch", blocks: ["D01", "C00"] },
      { code: "7810202", name: "Quản trị nhà hàng và dịch vụ ăn uống", blocks: ["D01", "C00"] }
    ]
  },
  {
    id: "nlu",
  ...
  },
  {
    ...
    majors: [
      ...
      { code: "7340301", name: "Kế toán", blocks: ["A00", "A01", "D01", "C00"] },
      { code: "7510605", name: "Logistics và Quản lý chuỗi cung ứng", blocks: ["A00", "A01", "D01", "C00"] },
      { code: "7380107", name: "Luật Kinh tế", blocks: ["A00", "A01", "D01", "C00"] },
      { code: "7320106", name: "Quan hệ công chúng", blocks: ["A00", "A01", "D01", "C00"] },
      { code: "7210403", name: "Thiết kế Đồ họa", blocks: ["H01", "H02", "H03", "H04", "H06"] },
      { code: "7210404", name: "Thiết kế Thời trang", blocks: ["H01", "H02", "H03", "H04", "H06"] },
      { code: "7580101", name: "Kiến trúc", blocks: ["V00", "V01", "H01", "H02"] },
      { code: "7480201", name: "Công nghệ thông tin", blocks: ["A00", "A01", "D07", "D08"] },
      { code: "7480103", name: "Kỹ thuật Phần mềm", blocks: ["A00", "A01", "D07", "D08"] },
      { code: "7220201", name: "Ngôn ngữ Anh", blocks: ["D01", "A01", "D14", "D15"] },
      { code: "7220204", name: "Ngôn ngữ Trung Quốc", blocks: ["D01", "A01", "D14", "D15"] },
      { code: "7720101", name: "Y khoa", blocks: ["B00", "B08", "A00", "D08"] },
      { code: "7720110", name: "Răng - Hàm - Mặt", blocks: ["B00", "B08", "A00", "D08"] },
      { code: "7720201", name: "Dược học", blocks: ["B00", "B08", "A00", "D07"] }
    ]
  },
  {
    id: "uef",
